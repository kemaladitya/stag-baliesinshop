...
import Customer from '@/components/Checkout/Platforms/mobile/constants/customer'
import Voucher from '@/components/Checkout/Platforms/mobile/constants/voucher'
import OrderInfo from '@/components/Checkout/Platforms/mobile/constants/order-info'
