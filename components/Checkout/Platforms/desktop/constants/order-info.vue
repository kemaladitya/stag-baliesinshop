...
<script>
import Subscription from '@/components/Checkout/Platforms/desktop/constants/order-type/subscription-order'
import Single from '@/components/Checkout/Platforms/desktop/constants/order-type/single-order'
import Package from '@/components/Checkout/Platforms/desktop/constants/order-type/package-order'
