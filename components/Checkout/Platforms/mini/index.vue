...
import Customer from '@/components/Checkout/Platforms/mini/constants/customer'
import Voucher from '@/components/Checkout/Platforms/mini/constants/voucher'
import OrderInfo from '@/components/Checkout/Platforms/mini/constants/order-info'
