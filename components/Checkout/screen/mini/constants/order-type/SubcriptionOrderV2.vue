    ...
    <div class="px">
        <v-expand-transition v-if="!voucher.loading">
            ...
            <v-card v-if="list_cart.length" height="100%" class="pt-2" flat tile>
                <div v-for="(item, index) in list_cart" :key="index" class="mb-2"
                    ...
                    <div>
                        <div class="d-flex flex-row pa-2">
                            ...
                            <v-spacer />
                            <div class="pr-1" style="font-size: 13px; font-weight: 600; color: #2196f3">
                                ...
                                <div style="font-size: 9px; font-weight: 600; padding-top: 2px; font-style: italic;"
                                    :style="
                            ...
                            <v-btn icon depressed dense small :ripple="false" @click="expand_detail(index)">
                    ...
                    <v-expand-transition>
                        <div class="pa-2 pb-0" v-if="expansion.length" v-show="expansion[index].show"
                            style="border-top: 1px solid #eaeaea">
                            <div v-for="(cart_item, idx) in item_parser(item.items).product" :key="idx" class="mb-2">
