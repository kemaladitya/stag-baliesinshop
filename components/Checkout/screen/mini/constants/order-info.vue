...
<script>
import Subscription from '@/components/checkout/screen/mini/constants/order-type/subscription-order'
import Single from '@/components/checkout/screen/mini/constants/order-type/single-order'
import Package from '@/components/checkout/screen/mini/constants/order-type/package-order'
