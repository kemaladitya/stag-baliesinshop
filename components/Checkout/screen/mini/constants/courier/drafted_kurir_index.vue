<template>
  <div class="pa-2">
    <FailedDialog :show="show_dialog" :message="show_dialog_message" :event_handler="event_handler" />
    ...
    <div style="
      ...
      <Customer />
      <v-divider />
      <Voucher :voucher="voucher" :submit="submit_voucher" :use_custom_voucher="use_custom_voucher" />
      <v-divider />
      ...
      <v-divider />
      <Payment :payment="payment" :select="select_payment" :general_total_order="general_total_order"
    ...
    <v-bottom-sheet :value="order_loading" persistent>
      <v-sheet>
        <center class="pa-3">
          <v-img width="130" src="https://miro.medium.com/max/882/1*9EBHIOzhE1XfMYoKz1JcsQ.gif" />
    ...
    <checkout-footer :execute_order="execute_order" :general_total_order="general_total_order"
      :checked_button="checked_button" :subtotal="subtotal" />
  </div>
</template>
