  ...
  <div class="pa-1 pt-2 text-left">
    ...
    <div class="pt-2">
      ...
      >
        ...
        <div style="font-weight: 500; color: dimgray">
          <div v-if="user_notes.length" class="pt-2" style="text-align: justify;">{{ user_notes }}</div>
    ...
    <div class="d-flex flex-row mt-3 mb-1 pa-1">
      ...
      <div class="d-flex flex-row pa-1">
        ...
        &nbsp;
        <v-spacer />
        <div style="font-weight: 500; color: rgb(25, 118, 210)">
          Rp
...
<script>
import Subscription from '@/components/checkout/screen/mobile/constants/order-type/subscription-order'
import Single from '@/components/checkout/screen/mobile/constants/order-type/single-order'
import Package from '@/components/checkout/screen/mobile/constants/order-type/package-order'
