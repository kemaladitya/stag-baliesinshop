          ...
          >
            <div>
              <div class="d-flex flex-row pa-2">
                <div class="pt-1 pl-1" style="font-size: 14px; font-weight: 500">
                  <!-- {{ parsedate(item.date) }} -->
                ...
                <div
                  class="pr-1"
                  style="font-size: 14px; font-weight: 500; color: #2196f3"
                >
                  <div style="font-size: 14px; font-weight: 500; color: #2196f3; text-align: right">
                    <v-spacer />
                    Rp {{
              ...
              <div class="pa-3">
                <v-card class="d-flex flex-row mb-2" flat>
                  <v-card
                    ...
                    flat
                  >
                    <v-card flat style="font-size: 12px; font-weight: 500">
                      Waktu Pengantaran :
                    </v-card>
                    <v-card
                      class="ml-2"
