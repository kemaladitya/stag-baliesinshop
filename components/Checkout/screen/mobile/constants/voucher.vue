<template>
  <div class="pa-1 pt-2 pb-2">
    ...
    <v-btn
      :class="voucher.selected ? null : 'mt-2'"
      style="background: #fd0; font-weight: 500; letter-spacing: normal; border-radius: 8px"
      depressed
      block
      @click="select_voucher = true"
    >
      {{ voucher.selected ? 'GANTI' : 'GUNAKAN' }} VOUCHER
    </v-btn>
    <v-progress-linear
    ...
    />
    <div v-else>
      <div v-if="!voucher.selected" style="height: 10px" />
