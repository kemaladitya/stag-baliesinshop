  ...
  <div>
    <div class="pa-1" style="padding-bottom: 180px">
      ...
      >
        ...
        <div class="d-flex flex-row pa-1">
          <div>Subtotal</div>
          <div
            v-if="order_type !== 'package-order' && (store.max_order && store.min_order)"
    ...
    <v-footer fixed padless color="white" style="width: 100%;">
      ...
      >
        ...
        <v-btn
          depressed
          style="text-transform: capitalize; letter-spacing: initial; color: black !important"
          color="#FD0"
...
<script>
import Single from '@/components/Cart/Platforms/mobile/type/single-order.vue'
import Subscription from '@/components/Cart/Platforms/mobile/type/subscription-order.vue'
import Package from '@/components/Cart/Platforms/mobile/type/package-order.vue'
