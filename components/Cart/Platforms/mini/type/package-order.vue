        ...
        >
          ...
          <v-card class="d-flex flex-row pa-1" style="background-color: lightgray !important;" flat>
            ...
            >
              ...
              >
                <div class="pa-2" style="width: 120px; height: 150px; background-color: white">
                  <v-img
                    :src="detail.image"
                    width="120"
                    height="120"
...
import SinglePackage from '@/components/Cart/Platforms/mini/type/package-order/type/single'
import MultiplePackage from '@/components/Cart/Platforms/mini/type/package-order/type/multiple'
import Lists from '@/components/Cart/Platforms/mini/type/package-order/list-items'
import FooterDetail from '@/components/Cart/Platforms/mini/type/package-order/footer-detail'
import RemovePackage from '@/components/Cart/Platforms/mini/type/package-order/remove-package'
