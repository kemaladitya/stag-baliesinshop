        ...
        >
          <div>
            <div class="d-flex flex-row pa-2">
              <div class="pt-2 pl-1" style="font-size: 11px; font-weight: 600">
                {{ parsedate(item.date) }}
              </div>
              <v-spacer />
              <div
                class="pr-1"
                style="font-size: 11px; font-weight: 600; color: #2196f3"
              >
                <div style="font-size: 11px; font-weight: 600; color: #2196f3; text-align: right">
                  <v-spacer />
                  {{ parseprice(item) }}
                </div>
                <div
            ...
            <div class="pa-3">
              <v-card class="d-flex flex-row mb-2" flat>
                <v-card
                  ...
                  flat
                >
                  <v-card flat style="font-size: 8px; font-weight: 600; text-align: left; padding-top: 1px">
                    Waktu Pengantaran :
                  </v-card>
                  <v-card
                ...
                >
                  <v-btn
                    ...
                    style="font-weight: 500; text-transform: capitalize; font-size: 9px"
                    height="16"
                  >
                    Pagi
                  </v-btn>
              ...
              >
                ...
                >
                  <v-card class="d-flex flex-row" flat width="100%">
                    ...
                    <v-card class="ma-3 mt-4 mr-1 ml-2" outlined>
                      <v-img
