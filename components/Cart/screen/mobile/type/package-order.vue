      ...
      >
        <div class="d-flex flex-row" style="width: 100%;">
          ...
          <div>
            ...
            <div style="font-size: 10px; color: grey" v-html="setup.description.replace(/\n/g, '<br>')" />
          </div>
        </div>
...
import SinglePackage from '@/components/cart/screen/mobile/type/package-order/type/single'
import MultiplePackage from '@/components/cart/screen/mobile/type/package-order/type/multiple'
import Lists from '@/components/cart/screen/mobile/type/package-order/list-items'
import FooterDetail from '@/components/cart/screen/mobile/type/package-order/footer-detail'
import RemovePackage from '@/components/cart/screen/mobile/type/package-order/remove-package'
