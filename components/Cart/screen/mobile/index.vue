...
<script>
import Single from "@/components/cart/screen/mobile/type/single-order";
import Subscription from "@/components/cart/screen/mobile/type/subscription-order";
import Package from "@/components/cart/screen/mobile/type/package-order";
