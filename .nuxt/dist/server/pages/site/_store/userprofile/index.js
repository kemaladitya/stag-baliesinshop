...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/site/_store/userprofile/index.vue?vue&type=template&id=7b9e5f21&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"mt-12 pt-6"},[(_vm.customer && _vm.customer.hasOwnProperty('status'))?_vm._ssrNode("<div class=\"mb-6\">","</div>",[_c('center',{staticStyle:{"font-weight":"600"}},[_vm._v("Yuk isi data terlebih dahulu")])],1):_c('center',{staticStyle:{"font-weight":"600"}},[_vm._v("Edit Data")]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"pa-5 pt-2 pb-2\">","</div>",[_vm._ssrNode("<div>","</div>",[_c('v-text-field',{attrs:{"label":"Nama","placeholder":"Nama Lengkap","hide-details":"","name":"name","rules":[_vm.rules.required]},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-6\">","</div>",[_c('v-text-field',{attrs:{"label":"No. Telephone","placeholder":"No. Telephone / No. Handphone","hide-details":"","name":"phone","rules":[_vm.rules.required]},model:{value:(_vm.phone),callback:function ($$v) {_vm.phone=$$v},expression:"phone"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-6\">","</div>",[_c('v-text-field',{attrs:{"label":"Email","placeholder":"Alamat Email","hide-details":"","name":"email","rules":[_vm.rules.required, _vm.rules.email]},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-6\">","</div>",[_c('v-select',{attrs:{"items":_vm.province.map(function (el) { return el.name; }),"label":"Provinsi","rules":[_vm.rules.required],"value":_vm.selected_province ? _vm.selected_province.name : 'Provinsi'},on:{"change":_vm.get_city}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-2\">","</div>",[_c('v-select',{attrs:{"items":_vm.city.map(function (el) { return el.name; }),"label":"Kota","rules":[_vm.rules.required],"value":_vm.selected_city ? _vm.selected_city.name : 'Kota'},on:{"change":_vm.get_sub_district}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-2\">","</div>",[_c('v-select',{attrs:{"items":_vm.sub_district.map(function (el) { return el.name; }),"label":"Kecamatan","rules":[_vm.rules.required],"value":_vm.selected_sub_district ? _vm.selected_sub_district.name : 'Kecamatan'},on:{"change":_vm.get_urban}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-2\">","</div>",[_c('v-select',{attrs:{"items":_vm.urban.map(function (el) { return el.name; }),"label":"Kelurahan","value":_vm.selected_urban ? _vm.selected_urban.name : 'Kelurahan',"rules":[_vm.rules.required]},on:{"change":_vm.select_postalcode}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[_c('v-text-field',{attrs:{"value":_vm.postal_code,"disabled":"","label":"Kode Pos","placeholder":"Kode Pos","hide-details":""}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-6\">","</div>",[_c('v-text-field',{attrs:{"label":"Alamat","placeholder":"Alamat Lengkap","hide-details":"","name":"address","rules":[_vm.rules.required]},model:{value:(_vm.address),callback:function ($$v) {_vm.address=$$v},expression:"address"}})],1),_vm._ssrNode(" "),_c('center',{staticClass:"mt-8"},[_c('v-btn',{staticStyle:{"text-transform":"capitalize"},attrs:{"disabled":_vm.submit_button,"width":"80%","color":"#fd0","depressed":"","rounded":"","large":""},on:{"click":function($event){_vm.confirm = true}}},[_vm._v("\n        Submit\n      ")])],1)],2),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"290"},model:{value:(_vm.confirm),callback:function ($$v) {_vm.confirm=$$v},expression:"confirm"}},[_c('v-card',{staticClass:"pa-4 pl-6 pr-6"},[_c('center',[_c('div',{staticStyle:{"font-size":"16px"}},[_vm._v("Apakah data Anda")]),_vm._v(" "),_c('div',{staticStyle:{"font-size":"16px"}},[_vm._v("sudah benar?")]),_vm._v(" "),_c('v-card',{staticClass:"d-flex flex-row mt-5",attrs:{"width":"100%","flat":""}},[_c('v-btn',{staticStyle:{"text-transform":"capitalize"},attrs:{"width":"49%","color":"#fd0","rounded":"","depressed":""},on:{"click":_vm.submit}},[_vm._v("\n            Lanjut\n          ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticStyle:{"text-transform":"capitalize"},attrs:{"width":"49%","color":"#999","outlined":"","rounded":"","depressed":""},on:{"click":function($event){_vm.confirm = false}}},[_vm._v("\n            Edit Data\n          ")])],1)],1)],1)],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/site/_store/userprofile/index.vue?vue&type=template&id=7b9e5f21&
