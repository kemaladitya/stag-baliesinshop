...
- `<CheckoutScreenMiniConstantsCourierDraftedKurirIndex>` | `<checkout-screen-mini-constants-courier-drafted-kurir-index>` (components/Checkout/screen/mini/constants/courier/drafted_kurir_index.vue)
