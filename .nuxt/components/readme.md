...
- `<BottomSheetMiniCart>` | `<bottom-sheet-mini-cart>` (components/Bottom-Sheet/MiniCart.vue)
...
- `<ProductFloatItemButton>` | `<product-float-item-button>` (components/product/FloatItemButton.vue)
- `<ProductHelloBar>` | `<product-hello-bar>` (components/product/HelloBar.vue)
- `<ProductListProductCategory>` | `<product-list-product-category>` (components/product/ListProductCategory.vue)
- `<ProductDetailv2>` | `<product-detailv2>` (components/product/ProductDetailv2.vue)
- `<ProductSendToBar>` | `<product-send-to-bar>` (components/product/SendToBar.vue)
- `<ProductSlickProduct>` | `<product-slick-product>` (components/product/SlickProduct.vue)
- `<ProductCatalog>` | `<product-catalog>` (components/product-catalog/index.vue)
- `<SharedEmptyCart>` | `<shared-empty-cart>` (components/shared/EmptyCart.vue)
- `<SharedLoadingv2>` | `<shared-loadingv2>` (components/shared/Loadingv2.vue)
- `<SharedNavbar>` | `<shared-navbar>` (components/shared/Navbar.vue)
- `<SharedOrderFailed>` | `<shared-order-failed>` (components/shared/OrderFailed.vue)
- `<SharedOrderLoading>` | `<shared-order-loading>` (components/shared/OrderLoading.vue)
- `<SharedTitleBar>` | `<shared-title-bar>` (components/shared/TitleBar.vue)
...
- `<CheckoutScreenMiniConstantsOrderInfoV2>` | `<checkout-screen-mini-constants-order-info-v2>` (components/Checkout/screen/mini/constants/OrderInfoV2.vue)
- `<CheckoutScreenMiniConstantsPaymentV2>` | `<checkout-screen-mini-constants-payment-v2>` (components/Checkout/screen/mini/constants/PaymentV2.vue)
- `<CheckoutScreenMiniConstantsVoucherV2>` | `<checkout-screen-mini-constants-voucher-v2>` (components/Checkout/screen/mini/constants/VoucherV2.vue)
...
- `<CheckoutScreenMiniConstantsCourierDraftedkuririndex>` | `<checkout-screen-mini-constants-courier-draftedkuririndex>` (components/Checkout/screen/mini/constants/courier/draftedkuririndex.vue)
