...
export { default as CartPlatformsMobileRpOrder } from '../../components/Cart/Platforms/mobile/rp-order.vue'
export { default as CheckoutPlatformsDesktopCustomer } from '../../components/Checkout/Platforms/desktop/customer.vue'
export { default as CheckoutPlatformsDesktop } from '../../components/Checkout/Platforms/desktop/index.vue'
export { default as CheckoutPlatformsDesktopKurir } from '../../components/Checkout/Platforms/desktop/kurir.vue'
export { default as CheckoutPlatformsDesktopNotes } from '../../components/Checkout/Platforms/desktop/notes.vue'
export { default as CheckoutPlatformsDesktopOrderDetail } from '../../components/Checkout/Platforms/desktop/order-detail.vue'
export { default as CheckoutPlatformsDesktopPayment } from '../../components/Checkout/Platforms/desktop/payment.vue'
export { default as CheckoutPlatformsDesktopSubtotal } from '../../components/Checkout/Platforms/desktop/subtotal.vue'
export { default as CheckoutPlatformsDesktopVoucher } from '../../components/Checkout/Platforms/desktop/voucher.vue'
export { default as CheckoutPlatformsMiniCustomer } from '../../components/Checkout/Platforms/mini/customer.vue'
export { default as CheckoutPlatformsMini } from '../../components/Checkout/Platforms/mini/index.vue'
export { default as CheckoutPlatformsMiniKurir } from '../../components/Checkout/Platforms/mini/kurir.vue'
export { default as CheckoutPlatformsMiniNotes } from '../../components/Checkout/Platforms/mini/notes.vue'
export { default as CheckoutPlatformsMiniOrderDetail } from '../../components/Checkout/Platforms/mini/order-detail.vue'
export { default as CheckoutPlatformsMiniPayment } from '../../components/Checkout/Platforms/mini/payment.vue'
export { default as CheckoutPlatformsMiniSubtotal } from '../../components/Checkout/Platforms/mini/subtotal.vue'
export { default as CheckoutPlatformsMiniVoucher } from '../../components/Checkout/Platforms/mini/voucher.vue'
export { default as CheckoutPlatformsMobileCustomer } from '../../components/Checkout/Platforms/mobile/customer.vue'
export { default as CheckoutPlatformsMobile } from '../../components/Checkout/Platforms/mobile/index.vue'
export { default as CheckoutPlatformsMobileKurir } from '../../components/Checkout/Platforms/mobile/kurir.vue'
export { default as CheckoutPlatformsMobileNotes } from '../../components/Checkout/Platforms/mobile/notes.vue'
export { default as CheckoutPlatformsMobileOrderDetail } from '../../components/Checkout/Platforms/mobile/order-detail.vue'
...
export const LazyLoadingListProduct = import('../../components/Loading/list_product.vue' /* webpackChunkName: "components/loading-list-product" */).then(c => c.default || c)
...
export const LazyBottomSheetCartProducts = import('../../components/Bottom-Sheet/Cart/products.vue' /* webpackChunkName: "components/bottom-sheet-cart-products" */).then(c => c.default || c)
export const LazyBottomSheetCheckoutCourier = import('../../components/Bottom-Sheet/Checkout/courier.vue' /* webpackChunkName: "components/bottom-sheet-checkout-courier" */).then(c => c.default || c)
export const LazyBottomSheetCheckoutLoading = import('../../components/Bottom-Sheet/Checkout/loading.vue' /* webpackChunkName: "components/bottom-sheet-checkout-loading" */).then(c => c.default || c)
export const LazyBottomSheetCheckoutPayment = import('../../components/Bottom-Sheet/Checkout/payment.vue' /* webpackChunkName: "components/bottom-sheet-checkout-payment" */).then(c => c.default || c)
export const LazyBottomSheetCheckoutVoucher = import('../../components/Bottom-Sheet/Checkout/voucher.vue' /* webpackChunkName: "components/bottom-sheet-checkout-voucher" */).then(c => c.default || c)
...
export const LazyCartPlatformsMobileRpOrder = import('../../components/Cart/Platforms/mobile/rp-order.vue' /* webpackChunkName: "components/cart-platforms-mobile-rp-order" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopCustomer = import('../../components/Checkout/Platforms/desktop/customer.vue' /* webpackChunkName: "components/checkout-platforms-desktop-customer" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktop = import('../../components/Checkout/Platforms/desktop/index.vue' /* webpackChunkName: "components/checkout-platforms-desktop" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopKurir = import('../../components/Checkout/Platforms/desktop/kurir.vue' /* webpackChunkName: "components/checkout-platforms-desktop-kurir" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopNotes = import('../../components/Checkout/Platforms/desktop/notes.vue' /* webpackChunkName: "components/checkout-platforms-desktop-notes" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopOrderDetail = import('../../components/Checkout/Platforms/desktop/order-detail.vue' /* webpackChunkName: "components/checkout-platforms-desktop-order-detail" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopPayment = import('../../components/Checkout/Platforms/desktop/payment.vue' /* webpackChunkName: "components/checkout-platforms-desktop-payment" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopSubtotal = import('../../components/Checkout/Platforms/desktop/subtotal.vue' /* webpackChunkName: "components/checkout-platforms-desktop-subtotal" */).then(c => c.default || c)
export const LazyCheckoutPlatformsDesktopVoucher = import('../../components/Checkout/Platforms/desktop/voucher.vue' /* webpackChunkName: "components/checkout-platforms-desktop-voucher" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniCustomer = import('../../components/Checkout/Platforms/mini/customer.vue' /* webpackChunkName: "components/checkout-platforms-mini-customer" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMini = import('../../components/Checkout/Platforms/mini/index.vue' /* webpackChunkName: "components/checkout-platforms-mini" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniKurir = import('../../components/Checkout/Platforms/mini/kurir.vue' /* webpackChunkName: "components/checkout-platforms-mini-kurir" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniNotes = import('../../components/Checkout/Platforms/mini/notes.vue' /* webpackChunkName: "components/checkout-platforms-mini-notes" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniOrderDetail = import('../../components/Checkout/Platforms/mini/order-detail.vue' /* webpackChunkName: "components/checkout-platforms-mini-order-detail" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniPayment = import('../../components/Checkout/Platforms/mini/payment.vue' /* webpackChunkName: "components/checkout-platforms-mini-payment" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniSubtotal = import('../../components/Checkout/Platforms/mini/subtotal.vue' /* webpackChunkName: "components/checkout-platforms-mini-subtotal" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMiniVoucher = import('../../components/Checkout/Platforms/mini/voucher.vue' /* webpackChunkName: "components/checkout-platforms-mini-voucher" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMobileCustomer = import('../../components/Checkout/Platforms/mobile/customer.vue' /* webpackChunkName: "components/checkout-platforms-mobile-customer" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMobile = import('../../components/Checkout/Platforms/mobile/index.vue' /* webpackChunkName: "components/checkout-platforms-mobile" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMobileKurir = import('../../components/Checkout/Platforms/mobile/kurir.vue' /* webpackChunkName: "components/checkout-platforms-mobile-kurir" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMobileNotes = import('../../components/Checkout/Platforms/mobile/notes.vue' /* webpackChunkName: "components/checkout-platforms-mobile-notes" */).then(c => c.default || c)
export const LazyCheckoutPlatformsMobileOrderDetail = import('../../components/Checkout/Platforms/mobile/order-detail.vue' /* webpackChunkName: "components/checkout-platforms-mobile-order-detail" */).then(c => c.default || c)
