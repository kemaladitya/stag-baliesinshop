<template>
    <div>
        ...
        <div v-else>
            <v-card v-if="order_type === 'package-order'" :class="screen == 'mini' ? 'pa-1 pl-2 pr-2' : 'pa-2'"
                id="b-subs-mode" class="pr-0" color="#dfdfdf" min-width="100%" style="margin-top: 50px" flat tile>
                ...
                <div :style="'font-size: ' + (screen == 'mini' ? '8px;' : '10px;')" class="pa-2 pt-1"
            ...
            " :class="screen == 'mini' ? 'pa-1 pl-2 pr-2' : 'pa-2'" id="b-subs-mode" class="pr-0" color="#dfdfdf"
                min-width="100%" style="margin-top: 50px" flat tile>
                <div class="d-flex flex-row pa-2 pb-1">
                    <div style="font-size: 12px; padding-top: 1px; font-weight: 600">
                        MODE LANGGANAN
                    </div>
                    <v-spacer />
                    <v-switch v-model="switch_rp" :class="screen == 'mini' ? 'ml-1 mr-0 pr-0' : null" class="pt-0 mt-0"
                        hide-details dense @change="subs_controller" />
                </div>
                <div :style="'font-size: ' + (screen == 'mini' ? '8px;' : '10px;')" class="pa-2 pt-0"
                    style="text-align: left;">
            ...
            <v-card v-if="
              ...
              && !loading_cart
              && cart.length
            " class="ma-2 mt-0 d-flex flex-row pa-2 pb-0" flat>
          ...
          >
            ...
            " class="pa-2 pt-0" style="padding-bottom: 100px;">
